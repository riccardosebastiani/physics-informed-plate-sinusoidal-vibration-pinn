...
class PINNet(nn.Module):
    ...
    def __init__(self, out_features=1, type='tanh', in_features=3, mode='mlp'):
        ...
        self.net = FCBlock(in_features=in_features, out_features=out_features, num_hidden_layers=1,
                           hidden_features=256, outermost_linear=True, nonlinearity=type,
                           weight_init=None)
        print(self)

    def forward(self, model_input, eval = False):
        ...
        #t = time_norm(t)
        o = self.net(torch.cat((x, y, t), dim=-1))#.squeeze()
        #if eval:
        #    return {'model_in': coords, 'model_out': o}
